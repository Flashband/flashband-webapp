...
angular.module('flashbandWebapp').controller('StatusCtrl', function ($scope, $sails, FlashbandRestFact, $interval, DTColumnDefBuilder, DTOptionsBuilder, DTColumnBuilder, $translate) {

  $scope.listShowgoers = [];

   $sails.on('connect', function (a,b,c) {

    $sails.get("/showgoer").success(function (showgoer) {
